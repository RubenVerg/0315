...
sequences =
  ...
  , (000203, a000203, "sigma(n), the sum of the divisors of n")
  , (000005, a000005, "d(n), the number of divisors of n")
  , (000217, a000217, "Triangular numbers")
  , (000010, a000010, "Euler totient function: count numbers &lt;= n and prime to n")
  , (000108, a000108, "Catalan numbers")
  , (000041, a000041, "Number of partitions of n")
  , (000290, a000290, "Squares")
  ...
  , (000720, a000720, "pi(n), the number of primes &lt;= n")
  , (007318, a007318, "Pascal's triangle read by rows: C(n,k) = binomial(n,k) = n!/(k!*(n-k)!), 0 &lt;= k &lt;= n")
  ...
  , (008683, a008683, "Möbius function mu(n)")
  ...
  , (001227, a001227, "Number of odd divisors of n")
  ...
  , (000583, a000583, "n^4")
  , (018252, a018252, "The nonprime numbers")
  ...
  , (000204, a000204, "Lucas numbers (beginning with 1): L(n) = L(n-1) + L(n-2) with L(1) = 1, L(2) = 3")
  , (000069, a000069, "Odious numbers")
  , (002322, a002322, "Reduced totient function psi(n)")
  ...
  , (008279, a008279, "Triangle T(n,k) = n!/(n-k)! (0 &lt;= k &lt;= n) read by rows")
