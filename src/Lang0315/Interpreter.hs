...
sequences =
  ...
  , (002322, (a002322, "Carmichael lambda function"))
  ...
  , (022958, (a022958, "2-n"))
  , (022996, (a022996, "40-n"))
  , (109613, (a109613, "Odd numbers repeated twice"))
  , (008585, (a008585, "Multiples of three"))
  , (069074, (a069074, "(2*n+2)*(2*n+3)*(2*n+4)"))
  , (010709, (a010709, "Always four"))
  , (059841, (a059841, "Is n even?"))
  , (000034, (a000034, "Cycle the numbers 1, 2"))
  , (033999, (a033999, "Cycle the numbers 1, -1"))
  , (010684, (a010684, "Cycle the numbers 1, 3"))
  , (010685, (a010685, "Cycle the numbers 1, 4"))
  , (010673, (a010673, "Cycle the numbers 0, 2"))
  , (010674, (a010674, "Cycle the numbers 0, 3"))
  , (010688, (a010688, "Cycle the numbers 1, 7"))
  , (105397, (a105397, "Cycle the numbers 4, 2"))
  , (049347, (a049347, "Cycle the numbers 1, -1, 0"))
  , (011655, (a011655, "Cycle the numbers 0, 1, 1"))
  , (061347, (a061347, "Cycle the numbers 1, 1, -2"))
  , (102283, (a102283, "Cycle the numbers 0, 1, -1"))
  , (130196, (a130196, "Cycle the numbers 1, 2, 2"))
  , (131534, (a131534, "Cycle the numbers 1, 2, 1"))
  , (010882, (a010882, "Cycle the numbers 1, 2, 3"))
  , (153727, (a153727, "Cycle the numbers 1, 4, 2"))
  , (080425, (a080425, "Cycle the numbers 0, 2, 1"))
  , (144437, (a144437, "Cycle the numbers 3, 3, 1"))
  , (131713, (a131713, "Cycle the numbers 1, -2, 1"))
  , (130784, (a130784, "Cycle the numbers 1, 3, 2"))
  , (169609, (a169609, "Cycle the numbers 1, 3, 3"))
  , (131561, (a131561, "Cycle the numbers 1, 1, -1"))
  , (052901, (a052901, "Cycle the numbers 3, 2, 2"))
  , (274339, (a274339, "Cycle the numbers 15, 24, 18"))
  , (073636, (a073636, "Cycle the numbers 1, 8, 9"))
  , (101000, (a101000, "Cycle the numbers 0, 1, 3"))
  , (131598, (a131598, "Cycle the numbers 2, 5, 8"))
  , (177702, (a177702, "Cycle the numbers 1, 1, 2"))
  , (131756, (a131756, "Cycle the numbers 2, -1, 3"))
  , (132677, (a132677, "Cycle the numbers 1, 2, -3"))
  , (146325, (a146325, "Cycle the numbers 1, 4, 1"))
  ...
  , (061256, (a061256, "Euler transform of the sums of divisors"))
  , (061255, (a061255, "Euler transform of totient function"))
  , (000332, (a000332, "binomial(n, 4)"))
  , (000391, (a000391, "Euler tranform of binomial(n, 4)"))
  , (005043, (a005043, "Riordan numbers"))
  , (358451, (a358451, "Inverse Euler transform of the Riordan numbers"))
  , (061257, (a061257, "Euler transform of the Carmichael lambda function"))
  , (000389, (a000389, "binomial(n, 5)"))
  , (000417, (a000417, "Euler tranform of binomial(n, 5)"))
  , (000579, (a000579, "binomial(n, 6)"))
  , (000428, (a000428, "Euler tranform of binomial(n, 5)"))
  , (107895, (a107895, "Euler tranform of the factorials"))
  , (030009, (a030009, "Euler tranform of the primes"))
  , (092119, (a092119, "Euler tranform of the ruler function"))
  , (051064, (a051064, "3-ruler function"))
  , (173241, (a173241, "Euler tranform of the 3-ruler function"))
  , (261031, (a261031, "Euler tranform of the Lucas numbers"))
  , (030012, (a030012, "Euler tranform of one and the primes"))
  , (030010, (a030010, "Inverse Euler tranform of the primes"))
  , (320779, (a320779, "Inverse Euler transform of the number of divisors function"))
  , (320781, (a320781, "Inverse Euler transform of the Möbius function"))
  , (320780, (a320780, "Inverse Euler transform of the sums of divisors"))
  , (320778, (a320778, "Inverse Euler transform of the totient function"))
  , (085686, (a085686, "Inverse Euler transform of Bell numbers"))
  , (030011, (a030011, "Inverse Euler transform of one and the primes"))
  , (112354, (a112354, "Inverse Euler transform of the factorials"))
  , (320776, (a320776, "Inverse Euler transform of the number of prime divisors with multiplicity"))
  ]
